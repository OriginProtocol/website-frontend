...
const OethBanner = () => {
  return (
    <div className="w-full bg-gradient-to-r from-gradient-oeth-from to-gradient-oeth-to h-[124px] flex items-center pl-6 md:pl-0 justify-start md:!justify-center text-white">
      <img
